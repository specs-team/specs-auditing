...
public class WebAppInitializer implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent servletContextEvent) {
        try {
            ...
            log.info("Audit-query-api was initialized successfully.");
        }
        catch (Exception e) {
            log.error("Failed to initialize audit-query-api: " + e.getMessage(), e);
            throw new RuntimeException("Failed to initialize audit-query-api.", e);
        }
    }
