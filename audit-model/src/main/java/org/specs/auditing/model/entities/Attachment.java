package org.specs.auditing.model.entities;
...
public class Attachment implements Serializable {
    ...
    public Attachment(String name, String contentType, Object content) throws JsonProcessingException {
        this.name = name;
        this.contentType = contentType;
        this.content = JsonUtils.getObjectMapper().writeValueAsString(content);
    }
    ...
    public String toString() {
        return "org.specs.auditing.model.entities.Attachment[ attachmentId=" + attachmentId + " ]";
    }
